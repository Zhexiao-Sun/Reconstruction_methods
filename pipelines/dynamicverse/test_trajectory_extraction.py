#!/usr/bin/env python3
"""
Test script for DynamicVerse trajectory extraction on all videos in a directory.
"""
...
from extrinsic_path.extract_extrinsic_path import load_config, process_dynamicverse_segments_for_trajectories


def main():
    parser = argparse.ArgumentParser(description="DynamicVerse batch trajectory extraction test")
