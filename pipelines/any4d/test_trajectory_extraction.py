#!/usr/bin/env python3
"""
Test script for Any4D trajectory extraction on all videos in a directory.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Any4D batch trajectory extraction test")
