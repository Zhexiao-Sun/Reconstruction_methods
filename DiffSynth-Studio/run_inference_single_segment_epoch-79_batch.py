...
LORA_PATH = Path("models/train/Wan2.2-TI2V-5B_lora_single_segment_121_frames/single_segment_epoch-79.safetensors")  # Set to Path("path/to/lora.safetensors") when using LoRA
LORA_ALPHA = 1.0
HEIGHT = 704
WIDTH = 1280
NUM_FRAMES = 121
